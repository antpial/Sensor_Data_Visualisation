...
QT_MOC_LITERAL(1, 14, 17), // "newPacketReceived"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 12), // "ParsedPacket"
QT_MOC_LITERAL(4, 46, 6), // "packet"
QT_MOC_LITERAL(5, 53, 11), // "serialError"
QT_MOC_LITERAL(6, 65, 5), // "error"
QT_MOC_LITERAL(7, 71, 8) // "readData"

    },
    "SerialManager\0newPacketReceived\0\0"
    "ParsedPacket\0packet\0serialError\0error\0"
    "readData"
};
...
void SerialManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newPacketReceived((*reinterpret_cast< const ParsedPacket(*)>(_a[1]))); break;
        case 1: _t->serialError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SerialManager::*)(const ParsedPacket & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::newPacketReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialManager::serialError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialManager::newPacketReceived(const ParsedPacket & _t1)
{
...
// SIGNAL 1
void SerialManager::serialError(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
